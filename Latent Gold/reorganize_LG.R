...
#### cleanup FSA ####
stacked2$demotwo_fsa[substr(stacked2$demotwo_fsa,2,2)=="O"] <- gsub("O","0",stacked2$demotwo_fsa[substr(stacked2$demotwo_fsa,2,2)=="O"])
stacked2$demotwo_fsa <- droplevels(stacked2$demotwo_fsa)

#### rural vs urban ####
stacked2$rural <- "urban"
stacked2$rural[substr(stacked2$demotwo_fsa,2,2)=="0"] <- "rural"
...
stacked2$jobs2[stacked2$jobs_other==1] <- "none/other"
...
stacked2$demoone_education2 <- as.character(stacked2$demoone_education)
stacked2$demoone_education2[stacked2$demoone_education=="elementary"] <- 'grade'
stacked2$demoone_education2[stacked2$demoone_education=="HS"] <- 'grade'
stacked2$demoone_education2[stacked2$demoone_education=="somepost"] <- 'uni'
stacked2$demoone_education2[stacked2$demoone_education=="bachelors"] <- 'uni'
stacked2$demoone_education2[stacked2$demoone_education=="college"] <- 'uni'
stacked2$demoone_education2[stacked2$demoone_education=="graduate"] <- 'uni'
...
#### numeric ocean days ####
stacked2$ocean_days <- as.character(stacked2$ocean_days)
stacked2$ocean_days[stacked2$ocean_days=="none"] <- 0
stacked2$ocean_days[stacked2$ocean_days=="lessthan5"] <- 2.5
stacked2$ocean_days[stacked2$ocean_days=="5to9"] <- 7
stacked2$ocean_days[stacked2$ocean_days=="10to29"] <- 19.5
stacked2$ocean_days[stacked2$ocean_days=="30to49"] <- 39.5
stacked2$ocean_days[stacked2$ocean_days=="50to100"] <- 75
stacked2$ocean_days[stacked2$ocean_days=="morethan100"] <- 150
stacked2$ocean_days[stacked2$ocean_days=="dontknow"] <- 0
stacked2$ocean_days <- as.numeric(stacked2$ocean_days)
...
stacked2$demoone_gender[stacked2$demoone_gender==""] <- "noresponse"
