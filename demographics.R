...
#remove test cases
userstats_BC_subsample=userstats_BC_subsample[userstats_BC_subsample$subsid!="test",]
userstats_english=userstats_english[userstats_english$subsid!="test",]
userstats_French=userstats_French[userstats_French$subsid!="test",]
...
write.csv(userstats_BC_subsample,"~/Documents/R/OHI survey results/userstats_BC_subsample_usable.csv")
write.csv(userstats_english,"~/Documents/R/OHI survey results/userstats_english_usable.csv")
write.csv(userstats_French,"~/Documents/R/OHI survey results/userstats_French_usable.csv")
